...
Main.main = function() {
	...
	var shaders = js.Lib.window.shaders = { };
	shaders["shader-fs"] = { type : "fragment", text : s.getFragmentData()};
	shaders["shader-vs"] = { type : "vertex", text : s.getVertexData()};
	webGLStart();
}
...
Shader.prototype.init = function(vertex,fragment) {
	this.start(true);
	var raw_mpos = vertex.mpos.rawData;
	null;
	null;
	null;
	null;
	...
	null;
	null;
	var raw_mproj = vertex.mproj.rawData;
	null;
	null;
	null;
	null;
